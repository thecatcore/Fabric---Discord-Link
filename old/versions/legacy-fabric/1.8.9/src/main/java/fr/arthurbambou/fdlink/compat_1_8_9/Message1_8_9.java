...
public class Message1_8_9 implements Message {
    ...
    public Message1_8_9(String message) {
        this.message = message;
        this.type = TextType.LITERAL;
    }

    public Message1_8_9(String key, String message, Object... args) {
        this.key = key;
        this.message = message;
        this.args = args;
    ...
    @Override
    public Message1_8_9 setStyle(Style style) {
        this.style = style;
        return this;
    }
    ...
    @Override
    public Message1_8_9 addSibbling(Message message) {
